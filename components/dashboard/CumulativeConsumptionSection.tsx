      ...
      <div className="h-80 w-full">
        <ResponsiveContainer>
          <AreaChart data={cumulativeData} margin={{ top: 5, right: 20, left: -5, bottom: 5 }}>
            ...
            <YAxis yAxisId="left" tick={{ fill: '#fb923c' }} stroke="#f97316" label={{ value: t('kWh'), angle: -90, position: 'insideLeft', fill: '#fb923c', dx: -10 }} />
            <YAxis yAxisId="right" orientation="right" tick={{ fill: '#22d3ee' }} stroke="#06b6d4" label={{ value: t('BDT'), angle: -90, position: 'insideRight', fill: '#22d3ee', dx: 10 }} />
